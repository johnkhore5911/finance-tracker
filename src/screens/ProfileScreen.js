    ...
    <ScreenWrapper>
      <View style={styles.container}>
        ...
        <View style={styles.useInfo}>
          ...
          <View>
            {/* user Image */}
            <Image source={require("../../assets/defaultAvatar.png")} style={styles.avatar} contentFit='cover' transition={100}/>
          </View>
          {/* name && email*/}
          <View style={styles.nameContainer}>
            <Typo size={24} fontWeight={'600'} color={colors.neutral100}>{userDetails.name}</Typo>
            <Typo size={15}  color={colors.neutral400}>{userDetails.email}</Typo>
          </View>
        </View>
